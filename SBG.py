...
def start_new_game():
    ...
    enemy1 = Enemy1(window.get_width(), 100, 'vizyal/monstersles/Monster_2/left/idle0.png', 'vizyal/monstersles/Monster_2/left/idle0.png', 100, 100, 0, 0, 600, 1200, 'Monster_2', fly=True)    
    enemy2 = Enemy1(4500, 350, 'vizyal/monstersles/Monster_5/right/fly0.png', 'vizyal/monstersles/Monster_5/right/fly0.png', 100, 100, 0, 0, 4500,5500 , 'Monster_5', fly=True)
    enemy3 = Enemy1(2800, 415, 'vizyal/monstersles/Monster_7/right/fly0.png', 'vizyal/monstersles/Monster_7/right/fly0.png', 100, 100, 0, 0, 2000,2900 , 'Monster_7', fly=False)
    enemy4 =  Enemy1(4300, 415, 'vizyal/monstersles/Monster_9/right/fly0.png', 'vizyal/monstersles/Monster_9/right/fly0.png', 100, 100, 0, 0, 4300,4600 , 'Monster_9', fly=False)
    enemy5 = Enemy1(9000, 350, 'vizyal/monstersles/Monster_1/right/fly0.png', 'vizyal/monstersles/Monster_1/right/fly0.png', 150, 150, 0, 0, 9000,9700 , 'Monster_1', fly=True)
    enemy6 = Enemy1(800, 100, 'vizyal/monstersles/Monster_2/left/idle0.png', 'vizyal/monstersles/Monster_2/left/idle0.png', 100, 100, 0, 0, 800, 1700, 'Monster_2', fly=True)    
    enemy7 = Enemy1(2300, 350, 'vizyal/monstersles/Monster_5/right/fly0.png', 'vizyal/monstersles/Monster_5/right/fly0.png', 100, 100, 0, 0, 2300,3000 , 'Monster_5', fly=True)
    enemy8 = Enemy1(3100, 415, 'vizyal/monstersles/Monster_7/right/fly0.png', 'vizyal/monstersles/Monster_7/right/fly0.png', 100, 100, 0, 0, 2600,3100 , 'Monster_7', fly=False)
    enemy9 =  Enemy1(3500, 415, 'vizyal/monstersles/Monster_9/right/fly0.png', 'vizyal/monstersles/Monster_9/right/fly0.png', 100, 100, 0, 0, 3500,4100 , 'Monster_9', fly=False)
    enemy10 = Enemy1(9400, 350, 'vizyal/monstersles/Monster_1/right/fly0.png', 'vizyal/monstersles/Monster_1/right/fly0.png', 150, 150, 0, 0, 9400,9500 , 'Monster_1', fly=True)
    enemy11 = Enemy1(800, 415, 'vizyal/monstersles/Monster_7/right/fly0.png', 'vizyal/monstersles/Monster_7/right/fly0.png', 100, 100, 0, 0, 800,1700 , 'Monster_7', fly=False)
    enemy12 =  Enemy1(7500, 415, 'vizyal/monstersles/Monster_9/right/fly0.png', 'vizyal/monstersles/Monster_9/right/fly0.png', 100, 100, 0, 0, 7500,8000 , 'Monster_9', fly=False)
    enemy13 = Enemy1(5000, 415, 'vizyal/monstersles/Monster_7/right/fly0.png', 'vizyal/monstersles/Monster_7/right/fly0.png', 100, 100, 0, 0, 5000,5500 , 'Monster_7', fly=False)
    enemy14 =  Enemy1(6000, 415, 'vizyal/monstersles/Monster_9/right/fly0.png', 'vizyal/monstersles/Monster_9/right/fly0.png', 100, 100, 0, 0, 6000,6700 , 'Monster_9', fly=False)
    enemy15 = Enemy1(6000, 250, 'vizyal/monstersles/Monster_5/right/fly0.png', 'vizyal/monstersles/Monster_5/right/fly0.png', 100, 100, 0, 0, 5300,6000 , 'Monster_5', fly=True)
    enemy16 = Enemy1(5900, 100, 'vizyal/monstersles/Monster_2/left/idle0.png', 'vizyal/monstersles/Monster_2/left/idle0.png', 100, 100, 0, 0, 5900, 6700, 'Monster_2', fly=True)
    ...
    enemys.add(enemy1,enemy2,enemy3,enemy4,enemy5,enemy6,enemy7,enemy8,enemy9,enemy10,enemy11,enemy12,enemy13,enemy14,enemy15,enemy16)
    ...
    while True:
        ...
        if enemy11.Attack:
            if enemy11 and not enemy11.Dead and hero.rect.colliderect(enemy11.attack_hitbox):
                hero.take_damage(10, healthbar)
        ...
        if enemy11.rect.colliderect(hero.rect):
            if not enemy11.Attack:
                enemy11.Attack = True
                enemy11.attack_timer = 10
                enemy11.Frame = 0

            if enemy11.Attack:
                enemy11.attack_timer -= 1
                if enemy11.attack_timer <= 0:
                    enemy11.Attack = False
        ...
        if enemy12.Attack:
            if enemy12 and not enemy12.Dead and hero.rect.colliderect(enemy12.attack_hitbox):
                hero.take_damage(10, healthbar)
        ...
        if enemy12.rect.colliderect(hero.rect):
            if not enemy12.Attack:
                enemy12.Attack = True
                enemy12.attack_timer = 10
                enemy12.Frame = 0

            if enemy12.Attack:
                enemy12.attack_timer -= 1
                if enemy12.attack_timer <= 0:
                    enemy12.Attack = False
        ...
        if enemy13.Attack:
            if enemy13 and not enemy13.Dead and hero.rect.colliderect(enemy13.attack_hitbox):
                hero.take_damage(10, healthbar)
        ...
        if enemy13.rect.colliderect(hero.rect):
            if not enemy13.Attack:
                enemy13.Attack = True
                enemy13.attack_timer = 10
                enemy13.Frame = 0

            if enemy13.Attack:
                enemy13.attack_timer -= 1
                if enemy13.attack_timer <= 0:
                    enemy13.Attack = False
        ...
        if enemy14.Attack:
            if enemy14 and not enemy14.Dead and hero.rect.colliderect(enemy14.attack_hitbox):
                hero.take_damage(10, healthbar)
        ...
        if enemy14.rect.colliderect(hero.rect):
            if not enemy14.Attack:
                enemy14.Attack = True
                enemy14.attack_timer = 10
                enemy14.Frame = 0

            if enemy14.Attack:
                enemy14.attack_timer -= 1
                if enemy14.attack_timer <= 0:
        ...
        if enemy15.Attack:
            if enemy15 and not enemy15.Dead and hero.rect.colliderect(enemy15.attack_hitbox):
                hero.take_damage(10, healthbar)
        ...
        if enemy15.rect.colliderect(hero.rect):
            if not enemy15.Attack:
                enemy15.Attack = True
                enemy15.attack_timer = 10
                enemy15.Frame = 0

            if enemy15.Attack:
                enemy15.attack_timer -= 1
                if enemy15.attack_timer <= 0:
                    enemy15.Attack = False
        ...
        if enemy16.Attack:
            if enemy16 and not enemy16.Dead and hero.rect.colliderect(enemy16.attack_hitbox):
                hero.take_damage(10, healthbar)
        ...
        if enemy16.rect.colliderect(hero.rect):
            if not enemy16.Attack:
                enemy16.Attack = True
                enemy16.attack_timer = 10
                enemy16.Frame = 0

            if enemy16.Attack:
                enemy16.attack_timer -= 1
                if enemy16.attack_timer <= 0:
                    enemy16.Attack = False
...
class Enemy1(Enemy):
    def __init__(self, x, y, image, file, width, height, speed_x, speed_y, patrol_left, patrol_right, monster, fly, groups=[]):
